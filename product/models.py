...
class Product(models.Model):
	...
	name          = models.CharField(max_length=45)
	main_image    = models.DecimalField(max_digits=18, decimal_places=2)
...
class ProductTag(models.Model):
	product	= models.ForeignKey('user.User', on_delete=models.CASCADE)
...
class ProductsHashTag(models.Model):
	name 		= models.CharField(max_length=45)
	product	= models.ForeignKey('Product', on_delete=models.CASCADE)
